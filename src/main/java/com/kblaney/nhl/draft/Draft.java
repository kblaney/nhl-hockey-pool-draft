 ...
 * A draft.
 * 
 * Methods in this interface throw an {@code IllegalStateException} if the state is not valid and
 * {@code IllegalArgumentException} if parameters are illegal.
 */
public interface Draft
{
   ...
   * @param draftPositionInFirstRound the poolee's draft position in the first round, which must be a legal draft
  ...
  /**
   * Returns a list of all draft picks thus far in the draft. Note that the list returned by this method is sorted by
   * draft pick number.
   * 
  ...
  /**
   * Returns a list of all draft picks of a specified poolee thus far in the draft. Note that the list returned by this
   * method is sorted by draft pick number.
   * 
   * @param poolee the poolee, which can't be null
   * 
   * @return the list of draft picks by the specified poolee thus far in the draft
   */
  List<DraftPick> getDraftPicksOfPoolee(Poolee poolee);

  /**
   * Returns a list of all draft picks of a specified poolee from a specified team thus far in the draft. Note that the
   * list returned by this method is sorted by draft pick number.
   * 
   * @param poolee the poolee, which can't be null
   * @param team the team, which can't be null
   * 
   * @return the list of draft picks by the specified poolee from the specified team thus far in the draft
   */
  List<DraftPick> getDraftPicksOfPooleeFromTeam(Poolee poolee, Team team);

  /**
   * Returns a list of all draft picks of a specified poolee at a specified position thus far in the draft. Note that
   * the list returned by this method is sorted by draft pick number.
   * 
   * @param poolee the poolee, which can't be null
   * @param position the position, which can't be null
   * 
   * @return the list of draft picks by the specified poolee at the specified position thus far in the draft
   */
  List<DraftPick> getDraftPicksOfPooleeAtPosition(Poolee poolee, Position position);

  /**
   * Returns a list of all draft picks from a specified team thus far in the draft. Note that the list returned by this
   * method is sorted by draft pick number.
   * 
   * @param team the team, which can't be null
   * 
   * @return the list of draft picks from the specified team thus far in the draft
   */
  List<DraftPick> getDraftPicksOnTeam(Team team);

  /**
   * Returns the most recent N draft picks. If fewer than N draft picks have been made, this method returns a list of
   * all draft picks made thus far.
   * 
   * @param numDraftPicksToReturn the number of draft picks to return (N), which can't be negative
   * 
   * @return the most recent N draft picks, with the most recent pick at the start of the list
   */
  List<DraftPick> getMostRecentNDraftPicks(int numDraftPicksToReturn);

  /**
   * Gets the set of teams from which a specified poolee is allowed to draft from.
   * 
   * @param poolee the poolee, which can't be null
   * 
