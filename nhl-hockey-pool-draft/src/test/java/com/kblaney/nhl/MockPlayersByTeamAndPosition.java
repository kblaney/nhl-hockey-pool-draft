...
public final class MockPlayersByTeamAndPosition implements PlayersByTeamAndPosition
{
  ...
  public MockPlayersByTeamAndPosition()
  {
    ...
    s.append("Mike,Comrie,PHO,F\n");
    s.append("Boyd,Devereaux,PHO,F\n");
    s.append("Krystofer,Kolanos,PHO,F\n");
    s.append("Petr,Nedved,PHO,F\n");
    s.append("Mike,Ricci,PHO,F\n");
    s.append("Jeff,Taffe,PHO,F\n");
    s.append("Shane,Doan,PHO,F\n");
    s.append("Mike,Leclerc,PHO,F\n");
    s.append("Ladislav,Nagy,PHO,F\n");
    s.append("Tyson,Nash,PHO,F\n");
    s.append("Oleg,Saprykin,PHO,F\n");
    s.append("Brett,Hull,PHO,F\n");
    s.append("Mike,Johnson,PHO,F\n");
    s.append("Fredrik,Sjostrom,PHO,F\n");
    s.append("Geoff,Sanderson,PHO,F\n");
    s.append("Tim,Jackman,PHO,F\n");
    s.append("Brad,Ference,PHO,D\n");
    s.append("Denis,Gauthier,PHO,D\n");
    s.append("Paul,Mara,PHO,D\n");
    s.append("Chris,McAllister,PHO,D\n");
    s.append("Derek,Morris,PHO,D\n");
    s.append("Sean,O'Donnell,PHO,D\n");
    s.append("Matthew,Spiller,PHO,D\n");
    s.append("David,Tanabe,PHO,D\n");
    s.append("Keith,Ballard,PHO,D\n");
    s.append("Zbynek,Michalek,PHO,D\n");
    s.append("Brian,Boucher,PHO,G\n");
    s.append("Curtis,Joseph,PHO,G\n");
    s.append("David,Leneveu,PHO,G\n");
